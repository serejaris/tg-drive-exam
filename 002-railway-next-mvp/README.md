# tg-drive-exam: Railway Thin MVP
...
On Railway start, `npm run start:railway` runs migrations, seeds questions, sets the Telegram webhook when secrets are present, then starts Next.js.
